...
const services = [
  ...
  { icon: '📊', num: '05', title: 'Gestión y Planificación de Obras',  desc: 'Control de costes, cronogramas y recursos para asegurar la rentabilidad y cumplimiento de plazos.' },
...
export default function Services() {
  ...
  return (
    <section id="servicios" className="section-pad bg-stone-50">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 md:mb-14 gap-4">
          ...
          <p className="md:text-right max-w-sm text-[14.5px] text-stone-500 leading-relaxed">
        ...
        <div ref={ref as React.RefObject<HTMLDivElement>}
          ...
          {services.map((s, i) => (
            <div key={s.num}
              className={`group bg-white border border-stone-200 rounded-[4px] p-6 relative overflow-hidden
                hover:shadow-lg hover:border-amber hover:-translate-y-1 transition-all duration-300
              ...
              <div className="text-[9px] tracking-[2px] uppercase text-stone-300 mb-1.5">{s.num}</div>
              <h3 className="font-serif text-[17px] text-blue mb-2 leading-snug">{s.title}</h3>
