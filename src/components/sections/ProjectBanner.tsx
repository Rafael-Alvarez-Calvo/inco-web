  ...
  return (
    <div className="bg-blue overflow-hidden">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2">
        ...
        <div className="px-6 sm:px-10 lg:px-16 py-10 lg:py-20 flex flex-col justify-center">
          ...
          <h2
            className="font-serif text-white font-semibold leading-snug mb-6"
          ...
          <p className="text-white/70 text-[15.5px] leading-relaxed mb-8">
            Desde autovías de alta capacidad hasta carreteras regionales,
            nuestro equipo acompaña a la administración pública y a las grandes
            constructoras en cada fase crítica del proyecto.
          </p>
          <div className="flex gap-2 flex-wrap mb-9">
            {tags.map((t) => (
              <span
                key={t}
                className="px-3.5 py-1.5 border border-white/20 rounded-sm text-[11px] tracking-wide uppercase text-white/60"
              >
                {t}
              </span>
            ))}
