...
const REFS: Reference[] = [
  ...
  { cat: 'urbanismo',   title: 'Urbanización PAU "La Veredilla III", SUBcO 10, Illescas (Toledo) — Toyota, Michelín',    client: 'Promotores privados',                     km: '3 M m²',                      tag: 'Dirección facultativa' },
        ...
        >
          <div className="border border-stone-200 rounded-[4px] overflow-hidden">
            <div className="grid grid-cols-12 bg-stone-50 border-b border-stone-200 px-5 py-3 text-[10px] tracking-[1.5px] uppercase text-stone-400 font-semibold">
              <div className="col-span-9 md:col-span-5">Proyecto</div>
            ...
            {filtered.map((r, i) => (
              ...
              >
                ...
                <div className="col-span-0 md:col-span-2 hidden md:flex flex-col gap-0.5">
                  {r.pem    && <span className="text-[11.5px] text-stone-500">PEM {r.pem}</span>}
                ...
                <div className="col-span-3 flex justify-end md:justify-start">
                  <span className={`inline-block text-[10px] tracking-wide uppercase font-semibold px-2.5 py-1 rounded-[4px] ${TAG_COLORS[r.tag] ?? 'bg-stone-100 text-stone-500'}`}>
                    {r.tag}
                  </span>
                </div>
              </div>
