  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
            <h2 className="section-title">
              Certificaciones <em>Applus+</em>
            </h2>
            <p className="max-w-sm text-[15px] text-stone-500 leading-relaxed">
              INCO está certificado en calidad, medio ambiente y seguridad
              laboral por Applus+, una de las entidades de certificación más
          ...
          {certs.map((c, i) => (
            ...
            >
              ...
              <div className="bg-blue px-7 py-5 flex items-center justify-between">
                <div>
                  <p className="text-[10px] tracking-[2px] uppercase text-white/50 mb-0.5">
                    Systems Certification
                  </p>
                  <h3 className="text-white font-serif text-[20px] font-semibold">
                    {c.name}
                  </h3>
              ...
              <div className="p-7 flex flex-col flex-1">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="bg-stone-100 text-stone-600 text-[11px] font-mono px-2 py-0.5 rounded">
                    {c.ref}
                  </span>
                </div>
                <p className="text-[13.5px] text-stone-500 leading-relaxed flex-1">
                  {c.desc}
                </p>
        ...
        {/* Bottom note */}
        <div
          className={`mt-10 bg-blue-light border border-blue/10 rounded-[4px] px-8 py-5 flex gap-4 items-start transition-all duration-700 delay-300 ${cardsIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
        >
          <Info
            size={18}
          ...
          <p className="text-[13.5px] text-blue/80 leading-relaxed">
            ...
            La Dirección de INCO está comprometida con la mejora continua de la
            eficacia del sistema, orientando todos los recursos hacia la
            satisfacción de las necesidades y expectativas de nuestros clientes,
            el respeto al medio ambiente y la seguridad de todas las personas
