...
const offices = [
  ...
  },
  {
    ...
    main: false,
    address:
      "Av. Tte. Gral. Gutiérrez Mellado, 9\n4ª Planta, Pta. 18\n30008 Murcia",
  },
];
        ...
        >
          {offices.map((o, i) => (
            ...
            >
              ...
              <span
                className={`inline-block px-3 py-1 rounded-full text-[10px] tracking-widest uppercase font-semibold mb-4 ${o.main ? "bg-amber-light text-amber" : "bg-blue-light text-blue"}`}
              >
                {o.role}
              </span>
