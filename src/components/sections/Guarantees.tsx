...
const items = [
  {
    ...
    desc: "Garantizamos el cumplimiento de todas las normativas técnicas, urbanísticas y de seguridad aplicables a cada proyecto.",
  },
  {
    title: "Buena ejecución garantizada",
    desc: "Cada proyecto revisado, coordinado y listo para ejecutarse sin imprevistos técnicos ni económicos.",
  },
  {
    title: "100% de plazos cumplidos",
    desc: "Desde 1993, ningún cliente ha esperado más de lo acordado. La puntualidad es parte de nuestra identidad.",
  },
  {
    title: "Equipo certificado y actualizado",
    desc: "Formación continua para aplicar siempre las últimas tecnologías, normativas y metodologías del sector.",
  },
];
          ...
          <ul className="divide-y divide-stone-100">
            {items.map((item, i) => (
              ...
              >
                ...
                <div>
                  <h4 className="text-[15px] font-semibold text-blue mb-1.5">
                    {item.title}
                  </h4>
                  <p className="text-[13.5px] text-stone-400 leading-relaxed">
                    {item.desc}
                  </p>
                </div>
              </li>
